# Generated by Django 2.2.16 on 2022-04-09 21:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Введите никнейм', max_length=150, unique=True, verbose_name='Username')),
                ...
                ('confirmation_code', models.CharField(blank=True, max_length=4, verbose_name='Секретный код')),
        ...
        migrations.AddField(
            model_name='title',
            name='genre',
            field=models.ManyToManyField(related_name='titles', through='reviews.TitlesGenres', to='reviews.Genre', verbose_name='Жанр'),
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('score', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(10), django.core.validators.MinValueValidator(1)], verbose_name='Оценка')),
